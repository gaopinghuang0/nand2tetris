# This is an intermediate version of CompilationEngine
# which is used to test symbol table.
# It is not the final version but I think it is a good idea to
# keep this version seperately in order to make the test_symbol_table.py runnable.
